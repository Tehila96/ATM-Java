...
public class AtmFx extends Application {
    ...
    public static ArrayList<Account> accounts = new ArrayList<>(); //Arraylist of Account class objects
    ...
    public static void main(String[] args) {
        ...
        try {
            inputFile = new FileReader("AccountDataIn.txt"); //File is initialized which contains accounts with their ids and opening balances
        ...
        while (parser.hasNextLine())   //Input file is parsed line by line
        {
            ...
            for (String elm: acc) //We look through each individual account
            {
                ...
                System.out.println(att[2]); //It contains account password
                System.out.println(att[3]); //It contains account balance
                Account account = new Account(Integer.parseInt(att[1]),Integer.parseInt(att[2]),Integer.parseInt(att[3])); //We initialize a single account object
            ...
            for(String elm: acc)
            {
                ...
                System.out.println(att[2]); //It contains account password
                System.out.println(att[3]); //It contains account balance
                Account password = new Account(Integer.parseInt(att[1]),Integer.parseInt(att[2]),Integer.parseInt(att[3]));
